...
LinearGradient _shimmerGradientDefault(
...
/// Create shimmer effect on a widget.
class ShimmerLoading extends StatefulWidget {
  ...
  /// Widget to apply the shimmer effect.
  final Widget child;
...
class ShimmerState extends State<Shimmer> with SingleTickerProviderStateMixin {
  ...
  LinearGradient get gradient {
    final linearGradient = _shimmerGradientDefault(context);
