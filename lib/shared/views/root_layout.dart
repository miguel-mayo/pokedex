...
import 'package:pokedex/router/router.dart' as router;
import 'package:pokedex/shared/views/adaptative_navigation.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, dimens) {
      void onSelected(int index) {
        final destination = router.destinations(context)[index];
